...
import { PatrimonioService } from '../../pages/patrimonios/services/patrimonio.service';
...
export class CabecalhoComponent {
  ...
  @Input() comFiltroPorMes: boolean = false;
  ...
  ngOnInit(): void {
    if (this.comFiltroPorMes) this.realizaValidacaoFiltroBuscaPorMes();
  }
  ...
  encaminhaTypeAheadParaServicoDeCaptacaoDeObjetosCorreto(valorDigitado: any) {
    ...
    if (this.realizaValidacaoFiltroBuscaPorMes()) {
      ...
      switch (this.modulo) {
        ...
        case 'patrimonios': {
          return this.patrimonioService.consultaObjetos(valorDigitado, this.pageableObject)
        }
        default: {
          return null;
        }
